...
// define the port - use env variable or default to 5001
...
// root endpoint - helpful info for visitors
app.get('/', (req, res) => {
  res.json({
    message: 'Candidate Selection API',
    endpoints: ['/api/health', '/api/candidates', '/api/candidates/stats']
  });
});
